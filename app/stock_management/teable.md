...
- `tblRfIcMK0A4QwV2qFM` → Production Log → `schema/table-tblRfIcMK0A4QwV2qFM.json` (SQL: `"bseTIY0IrZr61kt6u5E"."Production_Log"`)
...
- `tblylQJKygWi3ZAiRb8` → Overhead Allocation → `schema/table-tblylQJKygWi3ZAiRb8.json` (SQL: `"bseTIY0IrZr61kt6u5E"."Overhead_Allocation"`)
...
- `tbl6YsH3PwudftRGCow` → FG/PL/Production QC → `schema/table-tbl6YsH3PwudftRGCow.json` (SQL: `"bseTIY0IrZr61kt6u5E"."FG_PL_Production_QC"`)
...
- `tblaVMKDADXfdHimLRY` → Stock_Ledger → `schema/table-tblaVMKDADXfdHimLRY.json` (SQL: `"bseTIY0IrZr61kt6u5E"."Stock_Ledger"`)
- `tbliEs1RFlkpMkbcJz7` → Cutting Line → `schema/table-tbliEs1RFlkpMkbcJz7.json` (SQL: `"bseTIY0IrZr61kt6u5E"."Cutting_Line"`)
- `tblp5gnBXnCCA82HVLp` → Cutting Fabric → `schema/table-tblp5gnBXnCCA82HVLp.json` (SQL: `"bseTIY0IrZr61kt6u5E"."Cutting_Fabric"`)
...
- `tblTBvWP9zBOQ9cdj3D` → Stock Reservations → `schema/table-tblTBvWP9zBOQ9cdj3D.json` (SQL: `"bseTIY0IrZr61kt6u5E"."Stock_Reservations"`)
...
- `tblIjEJLmhAMrP6DTL3` → Express → `schema/table-tblIjEJLmhAMrP6DTL3.json` (SQL: `"bseTIY0IrZr61kt6u5E"."Express"`)
...
- `tblqugp8k8NsihBGtTC` → Planning → `schema/table-tblqugp8k8NsihBGtTC.json` (SQL: `"bseTIY0IrZr61kt6u5E"."Planning"`)
...
- `tblxkpNSxxYmitJCtWS` → Material Log → `schema/table-tblxkpNSxxYmitJCtWS.json` (SQL: `"bseTIY0IrZr61kt6u5E"."Material_Log"`)
...
- `tblkfp9kDtrRCoMNlK2` → RBEX Packing List → `schema/table-tblkfp9kDtrRCoMNlK2.json` (SQL: `"bseTIY0IrZr61kt6u5E"."RBEX_Packing_List"`)
...
- `tblWWFJSHv5B9uHizIO` → CNC Cutting PLAN → `schema/table-tblWWFJSHv5B9uHizIO.json` (SQL: `"bseTIY0IrZr61kt6u5E"."CNC_Cutting_Plan"`)
